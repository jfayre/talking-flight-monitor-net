...
namespace tfm
{
    public partial class frmPMDGCDU_backup : Form
    {
        ...
        {
                        if(cduGrid.SelectedCells.Count > 0)
            {
                if(cduGrid.SelectedCells[0].Value == null)
                {
                    cduGrid.SelectedCells[0].Value = cduGrid.SelectedCells[0].AccessibilityObject.GetChildCount();
                }
                            }
